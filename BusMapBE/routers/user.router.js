...
route.post('/udpate-password', [authMiddle.verifyToken, checkInfoMiddle.checkPassword], _userController.updatePassword)
route.put('/update-infomation', [authMiddle.verifyToken], _userController.updateInfor)
