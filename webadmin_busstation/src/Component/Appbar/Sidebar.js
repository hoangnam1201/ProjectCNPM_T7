        ...
        <div className={`sidebar ${props.class}`}>
            ...
            <div className="sidebar-content">
                ...
                <CollapseList text="Quản lý chuyến xe">
                    <NavLink exact to='/bus' className="sidebar-item nested">
                        <AiOutlineEye size="18px" />
                        <SidebarText>Xem</SidebarText>
                    </NavLink>
                    <NavLink exact to='/bus:/create' className="sidebar-item nested">
                        <BiBookAdd size="18px" />
                        <SidebarText>Thêm mới</SidebarText>
                    </NavLink>
                </CollapseList>
                <CollapseList text="Quản lý trạm xe">
                    <NavLink exact to='/busstop' className="sidebar-item nested">
                        <AiOutlineEye size="18px" />
                        <SidebarText>Xem</SidebarText>
                    </NavLink>
                    <NavLink exact to='/busstop:/create' className="sidebar-item nested">
                        <BiBookAdd size="18px" />
                        <SidebarText>Thêm mới</SidebarText>
                    </NavLink>
                </CollapseList>
                <CollapseList text="Quản lý user">
                    <NavLink exact to='/user' className="sidebar-item nested">
                        <AiOutlineEye size="18px" />
                        <SidebarText>Xem</SidebarText>
                    </NavLink>
                </CollapseList>
